    ...
    $root.database = (function() {
        ...
        database.Notify = (function() {
            ...
            Notify.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.database.Notify();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            Notify.fromObject = function fromObject(object) {
                if (object instanceof $root.database.Notify)
                    return object;
                var message = new $root.database.Notify();
        ...
        database.AntiLink = (function() {
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            AntiLink.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.database.AntiLink(), key, value;
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
             ...
             * @returns {string|null} `null` if valid, otherwise the reason why it is not
             */
            AntiLink.verify = function verify(message) {
                if (typeof message !== "object" || message === null)
                    return "object expected";
                if (message.status != null && message.hasOwnProperty("status"))
                    if (typeof message.status !== "boolean")
             ...
             * @returns {database.AntiLink} AntiLink
             */
            AntiLink.fromObject = function fromObject(object) {
                if (object instanceof $root.database.AntiLink)
                    return object;
                var message = new $root.database.AntiLink();
                if (object.status != null)
                    message.status = Boolean(object.status);
                if (object.platforms) {
        ...
        database.Group = (function() {
            ...
            Group.encode = function encode(message, writer) {
                ...
                if (message.notifications != null && Object.hasOwnProperty.call(message, "notifications"))
                    for (var keys = Object.keys(message.notifications), i = 0; i < keys.length; ++i) {
            ...
            Group.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.database.Group(), key, value;
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
                    ...
                    case 7:
                        ...
                        break;
                    case 8:
                        message.antilink = $root.database.AntiLink.decode(reader, reader.uint32());
                        break;
                    case 9:
                    ...
                    case 14:
                        ...
                        while (reader.pos < end2) {
                            ...
                            case 1:
                                ...
                                break;
                            case 2:
                                value = $root.database.Notify.decode(reader, reader.uint32());
                                break;
                            default:
                                reader.skipType(tag2 & 7);
                                break;
            ...
            Group.verify = function verify(message) {
                ...
                if (message.antilink != null && message.hasOwnProperty("antilink")) {
                    var error = $root.database.AntiLink.verify(message.antilink);
                    if (error)
                ...
                if (message.notifications != null && message.hasOwnProperty("notifications")) {
                    ...
                    var key = Object.keys(message.notifications);
                    for (var i = 0; i < key.length; ++i) {
                        var error = $root.database.Notify.verify(message.notifications[key[i]]);
                        if (error)
            ...
            Group.fromObject = function fromObject(object) {
                ...
                if (object.antilink != null) {
                    ...
                    message.antilink = $root.database.AntiLink.fromObject(object.antilink);
                }
                ...
                if (object.notifications) {
                    ...
                    message.notifications = {};
                    for (var keys = Object.keys(object.notifications), i = 0; i < keys.length; ++i) {
                        if (typeof object.notifications[keys[i]] !== "object")
                            throw TypeError(".database.Group.notifications: object expected");
                        message.notifications[keys[i]] = $root.database.Notify.fromObject(object.notifications[keys[i]]);
                    }
                }
                return message;
            };
